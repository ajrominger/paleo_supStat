...
> Following the suggestions of Reviewer 3, we have removed "punctuated equilibrium" as a literal explaination for our results.  This siminal concept in the field is still relevent, however, and we expand our discussion of it, as well as other concepts such as the Red Queen, in the discussion in lines XXXXX
...
> We were also concerned with the potential arbitrariness of taxonomies. We add discussion of this in line XXX (around yule1925). This is also the motivation for our permutation experiment in which we mantain the size of families, but permute the identities of their constituant taxa.  This experiment shows that real families contain biological information relevant to their diversification dynamics, i.e. there must be genuine characteristics that make the constituant taxa of real families arrise and go extinct according to a similar underlying process. We have also added in the supplement an analysis of the correlation between genus richness in families and their associated $\beta_k$ values. This is referenced in our motivation for the permutation experiment (around figSupp:betaByRich). 
...
> It is indeed a great resource that Bambach's guild designations are availible through the PBDB. We detail our utilization of these data in our response to the next comment. \newline\newline
...
> We have specified the coverage which was set at 0.75 to relect a similar average richness as produced with rarifacton and our new bias correction method, this is made clear in the supplement in the section "Evaluation of sampling bias correction methods".
