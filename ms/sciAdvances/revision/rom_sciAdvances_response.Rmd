...
> We do this now more clearly in the introduction first in the new section "Superstatistics of fossil biodiversity" and again re-affirm our assumptions in line 123--129

- some more discussion of possible explanations for the observed patterns

> We have added content throughout, especially in the Introduction and Discussion, see in particulare lines 88--101, 228--237, 242--253.

- a clearer unwrapping of the proposed connections to punctuated equilibrium (and other evolutionary hypotheses discussed).

> Following the suggestions of Reviewer 3, we have removed "punctuated equilibrium" as a literal explanation for our results.  This seminal concept in the field is still relevant, however, and we expand our discussion of it in the context of adaptive landscapes (lines 58--63, 228--241)
...
> We have made clear earlier on (lines 107--108) that we use 11 MY time bins as used previously in the literature (e.g. Alroy 2008 and 2010).
...
> We have included this analysis in the supplement and reference it in the main text (lines 137--143). We find that both the within clade and between clade distributions break down above the order level.
...
resulting stationary distribution of $\beta_k$ will be Gamma (40,41)."
...
> We agree that our treatment of "niche" was prime for misinterpretation and confusion, also noted by Reviewer 3. We have opted to replace the term "niche" with "region" or "location" in "adaptive space" following the adaptive landscape idea of Simpson (1953). We pay careful attention to this idea and our definition of it in lines 60--63. We also acknowledge the confusion around whether the $\beta_k$ define locations in "niche" space, or if the location leads to a specific $\beta_k$ value.  To clarify this, we have added to the text (lines 98--101) that we interpret each $\beta_k$ to be an emergent trait of a clade, emerging from its unique set of ecological strategies.
...
\newline\newline
We clarify the intentions of our superstatistical approach with a revised introduction that clearly motivates the study of complex patterns in the fossil record, and then details the superstatistical approach in a section titled "Superstatistics of fossil biodiversity."
...
> We certainly agree with the reviewer. We have introduced the statistical mechanical idea of equilibrium sooner so as to avoid confusing readers of our intentions and interpretations (lines 111--119).
...
> We have now extended our analysis to families and find, very interestingly, that family-level dynamics are also well captured by superstatistics, but the goodness of fit at the family level is just slightly not as good compared to the order level.  As the reviewer indicates, this adds credence to our idea.  We discuss this in greater depth in lines 171--173 and 187--194.
...
> We have taken this reviewer's advice to investigate the ecological composition of different taxonomic levels. This analysis reveals that families contain on average one ecological guild hypercube, orders contain on average 2, and classes and phyla contain many more. This analysis is in the supplemental section "Ecospace occupation of higher taxa" and referenced in the main text at lines 183--186.
...
fundamental contribution of this manuscript, but a new consensus
...
> We have revised Figure 2 to show all taxonomic levels (now including family as well), and have emphasized findings across these taxonomic levels (especially including family) throughout the results and discussion.
...
> We have included families.  And indeed the new results are very interesting and incorporated throughout the revision.  We find that families also conform to the superstatistical prediction equally well.
...
and Eldridge’s ‘punctuate equilibrium’, but that theory was developed
...
> Revised for added nuance and fairness to the literature; see lines 44--48.
...
Gaussian fluctuations in genus richness and neutral-like process (in
