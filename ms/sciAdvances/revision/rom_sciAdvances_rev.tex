...
macroevolutionary success. These characteristics result from
...
\begin{figure}[!h]
  ...
  fluctuations]{Distribution of fluctuations in genus richness within
    ...
    superstatistical approach, both when computed from integrating
...
wane systematically, and possibly non-symmetrically, through time
...
trait and diversification, a research area currently struggling with
model inadequacy \citep{rabosky2017fisse}. This framework could also
...
(data retrieval and processing script in the supplement). Collections
