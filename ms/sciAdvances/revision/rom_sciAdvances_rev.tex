...
% change the below to still mention "evolutionary coherence" but also
% talk about how if sstat works at order level, it should also work at
% family level, and that the fact that family level fluxes are closer
% to gaussian is in the right direction consistent with sstat because
% families are even more homo, and ultimately there is a
% characteristic lifespace of genera...if we can't find a citation for
% that don't stress it.
