...
adaptive landscape by higher taxa \citep{eldredgeGould1972,
  newman1985adaptive, hopkins2014}. We use, as an operational
definition, ``adaptive landscape'' to mean the set of taxon
characteristics that influence its macroevolution. Those
characteristics could be ecological such as substrate preference,
morphological such as ontology, or macroecological such as range size.
...
The magnitude of volatility of richness fluctuations will vary across
these islands of adaptive space as an emergent trait of a
clade. Ultimately this volatility trait emerges from the life
histories, ecologies, and evolutionary histories that characterize
each clade's occupancy in different regions of an adaptive
landscape. We do not attempt to disagnose which characteristics of
different regions account for volatility differences, but others have
found relationships between larval type \citep{jablonski2008}, body
...
different ecological strategies that may be more or less favorable
macroevlutionarily. These characteristics result from interactions
...
morphological, or macroecological) so that those new taxa occupy a new
...
\section{Comparison of sampling bias correction methods}
