...
> Here the key, which we admitted could (and now do) make more clear, is that it is not the traits per se which should correspond to volatility but rather the macroevolutionary fitness of those traits.  We clarify in lines 246--249 and 91--95.
