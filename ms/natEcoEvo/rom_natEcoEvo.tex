...
landscape.  The sepparation of timescales between background
...
evolutionary processes leading to the statis of order-level occupancy
...
across sub-systems evolves more slowly. This sepparation in time scale
...
\citep{macWilson} in recognition that while the idenity and exact
