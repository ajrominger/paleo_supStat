...
- remove sepkoski
- Fig 1 (especially scaled Gaussian and f(beta) for higher taxa) to be put in supp and discussed
- manuscript text
    - add more recent citations
    - add more thurough explaination and justification of correction approach 
    - hammer home the adaptive landscape idea--use it instead of "niche" or "ecological strategy"
    - make sure it's clear why we're removing sepkoski
